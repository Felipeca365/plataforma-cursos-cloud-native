    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Cualquier usuario autenticado puede consultar cursos e inscribirse
                .requestMatchers(HttpMethod.GET, "/api/cursos/**").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/inscripciones").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/inscripciones").authenticated()

                // Solo usuarios con extension_consultaRole=profesor pueden usar storage
